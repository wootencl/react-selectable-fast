...
var SelectableGroup = (function(_Component) {
      ...
      if (_this.props.contain) {
        var _this$selectableAreaD = _this.selectableAreaData,
          selectableAreaOffsetXRelativeToScrollContainer =
            _this$selectableAreaD.selectableAreaOffsetXRelativeToScrollContainer,
          selectableAreaOffsetYRelativeToScrollContainer =
            _this$selectableAreaD.selectableAreaOffsetYRelativeToScrollContainer
        /**
         * Contain Top
         */
        ...
        var adjustedBoxLeft = boxLeft - selectableAreaOffsetXRelativeToScrollContainer
        ...
        var adjustedBoxTop = boxTop - selectableAreaOffsetYRelativeToScrollContainer
  ...
  _createClass(SelectableGroup, [
    ...
    {
      key: 'getChildOffsetRelativeToParent',
      value: function getChildOffsetRelativeToParent(child, parent) {
        ...
        var selectableAreaOffsetXRelativeToScrollContainer = 0
        var selectableAreaOffsetYRelativeToScrollContainer = 0
        var childNode = child
        var parentNode = null
        do {
        ...
        return {
          selectableAreaOffsetXRelativeToScrollContainer: selectableAreaOffsetXRelativeToScrollContainer,
          selectableAreaOffsetYRelativeToScrollContainer: selectableAreaOffsetYRelativeToScrollContainer
        }
      }
    },
    {
