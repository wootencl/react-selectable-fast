  ...
  _createClass(SelectableGroup, [
    ...
    },
    {
      ...
      value: function getMousePositionRelativeToContainer(mouseEvent) {
        ...
        var _selectablesContainer = this.selectablesContainer.getBoundingClientRect(),
          containerLeft = _selectablesContainer.left,
          containerTop = _selectablesContainer.top
