  ...
  function SelectableGroup(props) {
    ...
    _this.checkScrollBottom = function(e, currentTop) {
      ...
      if (offset > 0 || e.clientY > window.innerHeight) {
        ...
        _this.scrollContainer.scrollTop = Math.min(newTop, _this.maxScrollHeight)
      }
    }
    ...
    _this.checkScrollRight = function(e, currentLeft) {
      ...
      if (offset > 0 || e.clientX > window.innerWidth) {
        ...
        _this.scrollContainer.scrollLeft = Math.min(newLeft, _this.maxScrollWidth)
      }
    }
    ...
    _this.openSelectbox = function(event) {
      ...
      if (_this.props.contain) {
        var _this$selectableAreaD = _this.selectableAreaData,
          offsetX = _this$selectableAreaD.offsetX,
          offsetY = _this$selectableAreaD.offsetY
        /**
         * Contain Top
         */
         ...
         * Contain Right
         */
        var selectableAreaWidth = _this.selectableArea.scrollWidth
        var adjustedBoxLeft = boxLeft - offsetX
         ...
         * Contain Bottom
         */
        var selectableAreaHeight = _this.selectableArea.scrollHeight
        var adjustedBoxTop = boxTop - offsetY
    ...
    _this.mouseDown = function(e) {
      ...
      if (
        (!_this.props.globalMouse && !(0, _nodeInRoot2.default)(e.target, _this.selectableArea)) ||
        _this.props.contain
      ) {
        var offsetData = (0, _getBoundsForNode2.default)(_this.selectableArea)
    ...
    _this.mouseUp = function(event) {
      ...
      if (!_this.mouseMoved && (0, _nodeInRoot2.default)(e.target, _this.selectableArea)) {
  ...
  _createClass(SelectableGroup, [
    ...
    },
    {
      ...
      value: function getSelectboxData() {
        ...
        if (this.props.contain) {
          var _selectableAreaData = this.selectableAreaData,
            selectableAreaOffsetXRelativeToScrollContainer =
              _selectableAreaData.selectableAreaOffsetXRelativeToScrollContainer,
            selectableAreaOffsetYRelativeToScrollContainer =
              _selectableAreaData.selectableAreaOffsetYRelativeToScrollContainer
    ...
    },
    {
      ...
      value: function getMousePositionRelativeToContainer(mouseEvent) {
        ...
        var _selectableArea$getBo = this.selectableArea.getBoundingClientRect(),
          containerLeft = _selectableArea$getBo.left,
          containerTop = _selectableArea$getBo.top
    ...
    {
      key: 'getSelectAreaOffsetRelativeToScrollContainer',
      value: function getSelectAreaOffsetRelativeToScrollContainer() {
        // TODO Figire out if container is in scroll container (should be)
        var _scrollContainer$getB = this.scrollContainer.getBoundingClientRect(),
          parentLeft = _scrollContainer$getB.left,
          parentTop = _scrollContainer$getB.top

        var _selectableArea$getBo2 = this.selectableArea.getBoundingClientRect(),
          childLeft = _selectableArea$getBo2.left,
          childTop = _selectableArea$getBo2.top
...
SelectableGroup.propTypes = {
   ...
   */
  selectableArea: _propTypes.string,
  /**
